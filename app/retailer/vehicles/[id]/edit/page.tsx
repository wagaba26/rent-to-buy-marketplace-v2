...
export default function EditVehiclePage() {
    ...
    useEffect(() => {
        if (isAuthenticated && user?.role === 'retailer' && vehicleId) {
            fetchVehicle();
        }
    ...
    const fetchVehicle = async () => {
        try {
            ...
            if (response.ok) {
                ...
                const vehicle = data.success ? data.data : data;
                ...
                setFormData({
                    ...
                    depositAmount: vehicle.deposit_amount?.toString() || '',
                    monthlyPayment: vehicle.monthly_payment?.toString() || '',
                    weeklyPayment: vehicle.weekly_payment?.toString() || '',
            ...
            <div className="pt-24 pb-12">
                <div className="container mx-auto px-4 md:px-6 max-w-4xl">
                    ...
                    <div className="mb-8">
                        ...
                        <h1 className="text-3xl font-bold text-white mt-4 mb-2">Edit Vehicle</h1>
                        <p className="text-text-secondary">Update vehicle details</p>
                    </div>
